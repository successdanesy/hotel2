...
$query = "
    SELECT b.guest_name, b.guest_id, b.room_number, b.checkin_date, b.checkout_date, 
           r.room_type, r.weekday_price, r.weekend_price,
           COALESCE(
...
$kitchen_charges = $guest['kitchen_order_total'];
$bar_charges = $guest['bar_order_total'];
...
<body>
    ...
    <div class="header">
        ...
        <p><strong>Bar/Kitchen Total:</strong> ₦<?php echo number_format($additional_charges, 2); ?></p>
        </div>
        <hr class="divider">
        <p class="total"><strong>Total Charges:</strong> ₦<?php echo number_format($total_charges, 2); ?></p>
